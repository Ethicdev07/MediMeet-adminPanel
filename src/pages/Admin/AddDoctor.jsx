...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onsSumitHandler} className="m-5 w-full">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <input
                ...
                value={docName}
                className="border border-gray-600 rounded px-3 py-2"
                type="text"
                placeholder="name"
                required
              />
            ...
            <div className="flex-1 flex flex-col gap-1">
              ...
              <select
                ...
                className="border border-gray-600 rounded px-3 py-2"
              >
                <option className="text-gray-800" value="1 Year">
                  1 Year
                </option>
                <option className="text-gray-800" value="2 Year">
                  2 Year
                </option>
                <option className="text-gray-800" value="3 Year">
                  3 Year
                </option>
                <option className="text-gray-800" value="4 Year">
                  4 Year
                </option>
                <option className="text-gray-800" value="5 Year">
                  5 Year
                </option>
                <option className="text-gray-800" value="6 Year">
                  6 Year
                </option>
                <option className="text-gray-800" value="7 Year">
                  7 Year
                </option>
                <option className="text-gray-800" value="8 Year">
                  8 Year
                </option>
                <option className="text-gray-800" value="9 Year">
                  9 Year
                </option>
                <option className="text-gray-800" value="10 Year">
                  10 Year
                </option>
              </select>
            </div>
          ...
          <div className="flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <select
                ...
                className="border border-gray-600 rounded px-3 py-2"
              >
                <option className="text-gray-800" value="General Physician">
                  General physician
                </option>
                <option className="text-gray-800" value="Gynecologist">
                  Gynecologist
                </option>
                <option className="text-gray-800" value="Dermatologist">
                  Dermatologist
                </option>
                <option className="text-gray-800" value="Pediatricians">
                  Pediatricians
                </option>
                <option className="text-gray-800" value="Neurologist">
                  Neurologist
                </option>
                <option className="text-gray-800" value="Gastroenterologist">
                  Gastroenterologist
                </option>
              </select>
            </div>
